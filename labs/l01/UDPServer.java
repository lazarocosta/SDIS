...
class UDPServer
{
    ...
    private Map <String, String> vehicles = new HashMap<String, String>();  // Map is an interface of HashMap, so a HashMap will have more

    private void addVehicle(String numberPlate, String ownerName)
    {
        this.vehicles.put(numberPlate, ownerName);  // numberPlate should be the key, since it is unique. A person may have more than 1 car.
}
    ...
    private String lookupVehicleOwner(String numberPlate)
    {
        ...
        String owner = this.vehicles.get(numberPlate);
