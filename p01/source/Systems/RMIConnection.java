 ...
 */
public class RMIConnection implements RMIInterface {

    public RMIConnection() {}

    @Override
    public String sendString() throws RemoteException {
        return null;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            RMIConnection obj = new RMIConnection();
            RMIConnection stub = (RMIConnection) UnicastRemoteObject.exportObject(obj, 0);
